...
public class ModifyUserActivity extends AppCompatActivity {
    ...
    String idUser, idPassword, userName, idSubject, nameHour, idHour,fit,  idGroup;
    Button btnModifyUser;
    EditText editPass, editIdUser, ediUserName;
    View viewer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ediUserName = (EditText)findViewById(R.id.editText_UserName);
    ...
    public boolean validate(){
        ...
        userName = ediUserName.getText().toString().trim();
        ...
        if (userName.isEmpty() )
        {
            ediUserName.setError("Porfavor llena el Nombre de Usuario");
            valid = false;
        }
    ...
    public void modifyUser(){
        ...
        boolean isInserted = db.modifyUser(idUser,idPassword, userName);
        if(isInserted == true)
